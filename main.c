...
void c(void)
{
	...
	printf("02) Vrai PRINTF : |%cp|\n", 'z');
	ft_printf("02) Mon PRINTF  : |%cp|\n", 'z');
	printf("03) Vrai PRINTF : |%ci|\n", '!');
	ft_printf("03) Mon PRINTF  : |%ci|\n", '!');
	printf("04) Vrai PRINTF : |%cs|\n", 'R');
	ft_printf("04) Mon PRINTF  : |%cs|\n", 'R');
	printf("05) Vrai PRINTF : |%cx|\n", 'R');
	ft_printf("05) Mon PRINTF  : |%cx|\n", 'R');
	printf("06) Vrai PRINTF : |%cX|\n", '3');
	ft_printf("06) Mon PRINTF  : |%cX|\n", '3');
	printf("07) Vrai PRINTF : |%cd|\n", '\0');
	ft_printf("07) Mon PRINTF  : |%cd|\n", '\0');
	printf("08) Vrai PRINTF : |%c|\n", '\0');
	ft_printf("08) Mon PRINTF  : |%c|\n", '\0');
	printf("09) Vrai PRINTF : |%c|\n", '\0');
	ft_printf("09) Mon PRINTF  : |%c|\n", '\0');
	printf("10) Vrai PRINTF : |%c|\n", NULL);
	ft_printf("10} Mon PRINTF  : |%c|\n", NULL);
	printf("11) Vrai PRINTF : |%cw|\n", 'a');
	ft_printf("11} Mon PRINTF  : |%cw|\n", 'a');
}
void s(void)
{
	ft_printf("--------------------%%s--------------------\n");	//Perfect
	...
	printf("02) Vrai PRINTF : |%sc|\n", "test");
	ft_printf("02) Mon PRINTF  : |%sc|\n", "test");
	printf("03) Vrai PRINTF : |%si|\n", "test2");
	ft_printf("03) Mon PRINTF  : |%si|\n", "test2");
	printf("04) Vrai PRINTF : |%sd|\n", "42");
	ft_printf("04) Mon PRINTF  : |%sd|\n", "42");
	printf("05) Vrai PRINTF : |%sp|\n", "42");
	ft_printf("05) Mon PRINTF  : |%sp|\n", "42");
	printf("06) Vrai PRINTF : |%sx|\n", "string");
	ft_printf("06) Mon PRINTF  : |%sx|\n", "string");
	printf("07) Vrai PRINTF : |%sX|\n", "string");
	ft_printf("07) Mon PRINTF  : |%sX|\n", "string");
	printf("08) Vrai PRINTF : |%su|\n", "precision");
	ft_printf("08) Mon PRINTF  : |%su|\n", "precision");
...
void num_u(void)
{
	...
	ft_printf("--------------------%%u--------------------\n");
	printf("01) Vrai PRINTF: |%ui|\n", 420);
	ft_printf("01) Mon PRINTF : |%ui|\n", 420);
	printf("02) Vrai PRINTF: |%u|\n", -420);
	ft_printf("02) Mon PRINTF : |%u|\n", -420);
	printf("19) Vrai PRINTF : |%ud|\n", 0);
	ft_printf("19) Mon PRINTF :  |%ud|\n", 0);
	printf("20) Vrai PRINTF : |%up|\n", -1234567);
	ft_printf("20) Mon PRINTF :  |%up|\n", -1234567);
	printf("21) Vrai PRINTF : |%uc|\n", 123456798237472);
	ft_printf("21) Mon PRINTF :  |%uc|\n", 123456798237472);
	printf("21) Vrai PRINTF : |%us|\n", -123456798237472);
	ft_printf("21) Mon PRINTF :  |%us|\n", -123456798237472);
